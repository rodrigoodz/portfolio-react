...
const Contact = () => {
  return (
    <div className="flex ">
      ...
      >
        <svg
          className="w-8 h-8 mx-2 text-white transition duration-300 ease-in-out rounded-full fill-current md:h-10 md:w-10 hover:text-gray-300 "
          viewBox="0 0 24 24"
        >
      ...
      <a href="https://github.com/rodrigoodz" target="blank">
        <svg
          className="w-8 h-8 mx-2 text-white fill-current md:h-10 md:w-10 "
          viewBox="0 0 24 24"
        >
      ...
      <a href="/" target="blank">
        <svg
          className="w-8 h-8 mx-2 bg-white rounded-full md:h-10 md:w-10 "
          viewBox="-8 -8 40 40"
        >
