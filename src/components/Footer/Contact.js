...
const Contact = () => {
  return (
    <div className="flex ">
      ...
      >
        <svg
          className="h-10 w-10 mx-2 text-white fill-current rounded-full hover:text-gray-300 transition duration-300 ease-in-out "
          viewBox="0 0 24 24"
        >
      ...
      <a href="https://github.com/rodrigoodz" target="blank">
        <svg
          className="h-10 w-10 mx-2 text-white fill-current  "
          viewBox="0 0 24 24"
        >
      ...
      <a href="/" target="blank">
        <svg
          className="h-10 w-10 mx-2 bg-white rounded-full "
          viewBox="-8 -8 40 40"
        >
